...
public class PlayerTwoWinScreen implements Screen {

	private static final int PLAYER_2_WIN_SCHRIFTZUG_breite = 860;
	private static final int PLAYER_2_WIN_SCHRIFTZUG_hoehe = 65;
	...
	public PlayerTwoWinScreen(SEPgame game) {
		this.game=game;
		
		WinSchriftzug = new Texture("PlayerTwoWin_title.png");
	...
	public void render(float delta) {
		...
		game.batch.draw(WinSchriftzug, Gdx.graphics.getWidth() / 2 - PLAYER_2_WIN_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - PLAYER_2_WIN_SCHRIFTZUG_hoehe - 100, PLAYER_2_WIN_SCHRIFTZUG_breite, PLAYER_2_WIN_SCHRIFTZUG_hoehe);
