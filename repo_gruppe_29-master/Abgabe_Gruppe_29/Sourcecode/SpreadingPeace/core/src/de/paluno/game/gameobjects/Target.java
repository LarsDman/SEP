...
public class Target extends Tank {
	...
	public Target(Gamemode playScreen, Vector2 spawnPoint, InputProvider input, int team, ArrayList<String> settings,
...
//
//	public Target(Deathmatch playScreen, Vector2 spawnPoint, InputProvider input) {
//		super(playScreen, spawnPoint, input, 1, settings);
//		spriteBody = new Sprite(new Texture("Zielscheibe30x30.png"));
//	}
//
