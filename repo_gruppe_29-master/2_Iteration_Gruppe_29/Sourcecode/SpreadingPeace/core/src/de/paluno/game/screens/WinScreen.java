...
public class WinScreen implements Screen {
	...
	private static final int WIN_SCHRIFTZUG_hoehe = 120;
	...
	public void render(float delta) {
		...
		game.batch.draw(WinSchriftzug, Gdx.graphics.getWidth() / 2 - WIN_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - WIN_SCHRIFTZUG_hoehe - 200, WIN_SCHRIFTZUG_breite, WIN_SCHRIFTZUG_hoehe);
