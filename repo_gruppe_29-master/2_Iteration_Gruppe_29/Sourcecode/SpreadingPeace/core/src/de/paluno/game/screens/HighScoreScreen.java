...
public class HighScoreScreen implements Screen {
	...
	SEPgame game;
	int score, Highscore1, Highscore2, Highscore3, Highscore4, Highscore5;
	...
	public HighScoreScreen (SEPgame game, int score) {
		...
		this.Highscore1 = prefs.getInteger("highscore1", 0);
	...
	public void render(float delta) {
		...
		float ResetHighscoreX = Gdx.graphics.getWidth() - ResetHighscoreLayout.width*1.5f;
		...
		game.batch.draw(HighScoresSchriftzug, Gdx.graphics.getWidth() / 2 - HIGHSCORES_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - HIGHSCORES_SCHRIFTZUG_hoehe - 100, HIGHSCORES_SCHRIFTZUG_breite, HIGHSCORES_SCHRIFTZUG_hoehe);
		scoreFont.draw(game.batch, HighscoreLayout1, Gdx.graphics.getWidth() / 2 - HIGHSCORES_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - HIGHSCORES_SCHRIFTZUG_hoehe - 200);
		scoreFont.draw(game.batch, HighscoreLayout2, Gdx.graphics.getWidth() / 2 - HIGHSCORES_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - HIGHSCORES_SCHRIFTZUG_hoehe - 250);
		scoreFont.draw(game.batch, HighscoreLayout3, Gdx.graphics.getWidth() / 2 - HIGHSCORES_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - HIGHSCORES_SCHRIFTZUG_hoehe - 300);
		scoreFont.draw(game.batch, HighscoreLayout4, Gdx.graphics.getWidth() / 2 - HIGHSCORES_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - HIGHSCORES_SCHRIFTZUG_hoehe - 350);
		scoreFont.draw(game.batch, HighscoreLayout5, Gdx.graphics.getWidth() / 2 - HIGHSCORES_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - HIGHSCORES_SCHRIFTZUG_hoehe - 400);
