...
public class F_L_O_W_E_R extends java.lang.Object implements Renderable, Updatable, PhysicsObject {
	...
	public F_L_O_W_E_R(PlayScreen playScreen, com.badlogic.gdx.math.Vector2 origin,
	...
	public void setupBody() {
		...
		// Create Body
		body = PlayScreen.getWorld().createBody(flowerBodyDef);
	...
	public void explode() {
		...
		System.out.println("dies Blume ist zerst�rt");
