...
public class PlayerOneWinScreen implements Screen {

	private static final int PLAYER_1_WIN_SCHRIFTZUG_breite = 820;
	private static final int PLAYER_1_WIN_SCHRIFTZUG_hoehe = 65;
	...
	public PlayerOneWinScreen(SEPgame game) {
		this.game=game;
		
		WinSchriftzug = new Texture("PlayerOneWin_title.png");
	...
	public void render(float delta) {
		...
		game.batch.draw(WinSchriftzug, Gdx.graphics.getWidth() / 2 - PLAYER_1_WIN_SCHRIFTZUG_breite / 2, Gdx.graphics.getHeight() - PLAYER_1_WIN_SCHRIFTZUG_hoehe - 100, PLAYER_1_WIN_SCHRIFTZUG_breite, PLAYER_1_WIN_SCHRIFTZUG_hoehe);
